...
The weather feature uses `OPENWEATHER_API_KEY`. The email feature uses `VOICE_EMAIL`, `VOICE_EMAIL_PASSWORD`, and `VOICE_EMAIL_RECEIVER`. Keep API keys and passwords private. Do not upload them to GitHub.
